    ...
    def step(self,action):
        ...
        if (command == const.AMSG_SCAN):
            ...
            if(targetport==self.vulnport and self.vulntype==const.VULNTYPE_ACCESSPOINT):
                ...
                return msg,-1,self.termination,'SERVER: Discovered process: {0}'.format([const.STRING_ACCESSPOINTS[a] for a in self.vulnvalue])
                ...
                return msg,-1,self.termination,'SERVER: Discovered exploitable vulnerability with param: {0}'.format(self.vulnvalue)
